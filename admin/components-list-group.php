...
session_start();
 ...
 //  echo $role;
  //  $sessionRec=$admrecS['session'];
    ...
    $result = resultnew( "SELECT * FROM spgs_basicinfo WHERE faculty LIKE '%Medical Rehabilitation%' AND regno NOT IN (SELECT regno from admitted_2022) ORDER BY `dept`,`programme` ");
...
<head>
  ...
  <title>Medical Rehab Applicants </title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Medical Rehabilitation Applicants</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
          <li class="breadcrumb-item">Applications</li>
          <li class="breadcrumb-item active">Medical Rehabilitation</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Medical Rehabilitation Applications</h5>
<?php 
              echo "</head>";
    //echo "<body>";
