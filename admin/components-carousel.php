...
session_start();
 ...
 //  echo $role;
  //  $sessionRec=$admrecS['session'];
    ...
    $result = resultnew( "SELECT * FROM spgs_basicinfo WHERE faculty='Basic Medical Sciences' AND regno NOT IN (SELECT regno from admitted_2022) ORDER BY `dept`,`programme` ");
...
<head>
  ...
  <title>Applicants / Basic Medical Sciences</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Basic Medical Science</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
