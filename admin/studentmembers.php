    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Student Membership Payments</li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Student Membership Payment Records</h5>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                 ...
                 $query = "SELECT *
          FROM payments   WHERE payment_status = 'PAID' AND  payment_type = 'membership' AND membership_category='Student'";
