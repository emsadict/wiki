...
$result2 = resultnew( "SELECT `dept` as programmes, COUNT(dept) AS frequency  FROM `course_reg` WHERE session='2023/2024' AND `semester`='FIRST' GROUP BY `dept` ");

foreach ($result2 as $data2) {
      $programme2[]=$data2['programmes'];
        ...
        <!-- Left side columns -->
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Screened Students as of <span>/Today</span></h5>
              ...
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  new Chart(document.querySelector('#lineChart'), {
                    type: 'line',
                    data: {
                     labels: <?php echo json_encode($programme); ?>,
                      datasets: [{
                        label: 'Line Chart',
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Course Registration as of <span>| Today</span></h5>
                  ...
                  new Chart(document.querySelector('#barChart'), {
                    ...
                    data: {
                     // labels: ['Doctorate', 'Masters', 'PGD'],
                      labels: <?php echo json_encode($programme2); ?>,
                      datasets: [{
                        label: 'Bar Chart',
                        //data: [65, 59, 80, 50 ],
