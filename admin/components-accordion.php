...
$sql = "SELECT * FROM biodata where mem_category='regular'";
...
<?php 
    ...
    echo "<hr>";
    echo "Available Regular Membership:" . $data['total'];
  /*
    ...
    echo "<th><a href='components-badges.php'><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>Associate</button></th>";
  ...
  echo "<th>Delete Users</th>";
    ...
    while ($retrieve = mysqli_fetch_array($result)) {
     ...
     // $Faculty = $retrieve['faculty'];
      ...
      echo "<th><a href='components-accordion.php?delete=$id' onclick=\"return confirm('Are you sure you want to delete this user?');\"><button class='btn btn-danger'>Delete</button></a></th>";
      echo "<th><a href='#'><button class='btn btn-primary'>Edit</button></th>";
      echo "<th><a href='components-accordion.php?reactivate=$id'><button class='btn btn-warning'>Reactivate</button></a></th>";
