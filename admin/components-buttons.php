...
session_start();
 ...
 //  echo $role;
  //  $sessionRec=$admrecS['session'];
    ...
    $result = resultnew( "SELECT * FROM spgs_basicinfo WHERE faculty='Sciences' AND regno NOT IN (SELECT regno from admitted_2022) ORDER BY `dept`,`programme` ");
...
<head>
  ...
  <title>Applicants / Sciences</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Sciences</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
