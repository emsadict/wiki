...
$sql = "SELECT * FROM biodata where mem_category='Associate'";
...
<?php 
    ...
    echo "<hr>";
    echo "Available Associate Membership:" . $data['total'];
  /*
...
/*
    ...
    echo "<hr>";
    echo "<div class='text-primary'><center><h3>Associate Members </h3></center>";
    echo "</br>";
