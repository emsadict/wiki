...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>View Departmental Payment Records</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Departmental Payment Records</h5>
          ...
          ON p.regno = s.regno WHERE p.status = 'PAID' AND  p.payment_type = 'Departmental'";
