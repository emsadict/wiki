...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>View School fee Payment Records</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admindashboad.php">Dashboard</a></li>
          <li class="breadcrumb-item">Payments</li>
          <li class="breadcrumb-item active">School fee Payment Records</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">School fee Payment Records</h5>
          ...
          ON p.regno = s.regno WHERE p.status = 'PAID' AND  p.payment_type = 'Tuition Fee'";
