...
session_start();
 ...
 //  echo $role;
  //  $sessionRec=$admrecS['session'];
    ...
    $result = resultnew( "SELECT * FROM spgs_basicinfo WHERE faculty='Public Health' AND regno NOT IN (SELECT regno from admitted_2022) ORDER BY `dept`,`programme` ");
...
<head>
  ...
  <title>Applicants / Public Health</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Public Health</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
