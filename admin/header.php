<?php 
 ...
 //$adminrec=getRecs("admin_table","username",$user);
   //$role = $adminrec['role'];
 //mysqli_num_rows() expects parameter 1 to be mysqli_result, string given in /home/spgsportal/public_html/admin/admindashboad.php on line 23
...
<head>
  ...
  <title>Dashboard - WIKIMEDIA USER GROUP NIGERIA</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="#" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-sm-block">WIKIMEDIA </span> 
      </a>
