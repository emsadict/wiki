<footer>
                ...
                <div class="kingster-copyright-wrapper">
                    <div class="kingster-copyright-container kingster-container clearfix">
                        <div class="kingster-copyright-left kingster-item-pdlr">Copyright All Right Reserved 2025,Wikimedia Usergroup Nigeria</div>
                        <div class="kingster-copyright-right kingster-item-pdlr">
                            <div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-none-align" id="div_1dd7_112">
                           <h6 style="padding-left: 30px; color:#ffffff;"> Follow us:</h6>
                           <a href="https://www.facebook.com/WikimediaNG" target="_blank" class="gdlr-core-social-network-icon" title="facebook">
